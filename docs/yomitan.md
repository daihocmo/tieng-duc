...
Yomitan là một extension (tiện ích mở rộng) trên trình duyệt (Chrome, Chromium-based hoặc Firefox) cho phép bạn tra cứu các từ Tiếng Đức cả nghĩa lẫn cách đọc trên trang web một cách dễ dàng.
...
Bạn có thể xem danh sách [từ điển Tiếng Đức cho Yomitan](https://github.com/MarvNC/yomitan-dictionaries?tab=readme-ov-file#korean). Dưới đây là một số từ điển mà mình tìm được (Bấm vào tên từ điển để tải luôn nhé):
...
7. Sau khi hoàn tất, bạn có thể kiểm tra Yomitan bằng cách giữ phím ++shift++ và di chuột qua văn bản Tiếng Đức. Thử di chuột vào cái này xem: Deutsch. Nó sẽ hiện một pop-up box hiển thị các định nghĩa được chia theo từ điển.
...
Trên thanh công cụ trình duyệt, nếu bạn chọn biểu tượng Yomitan, sau đó chọn biểu tượng ![search icon](img/yomitan-search.png) hoặc dùng tổ hợp phím tắt `Alt+ Insert`, bạn có thể truy cập vào "Yomitan Search" - bạn có thể sử dụng Yomitan như một từ điển Tiếng Đức riêng (Hoàn toàn Offline).
...
**Frequency - Korean CC100** - Danh sách tần suất các từ xuất hiện trên Internet của Đức
