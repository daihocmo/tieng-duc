...
*Nếu bạn không cần đọc phần mở đầu, hãy đến luôn phần **[Cách để học Tiếng Đức](#21-cach-hoc-tieng-uc)**.*

![https://safebooru.org/index.php?page=post&s=view&id=5521525](img/sleep-well.png){:  style="display: block; margin: 0 auto; max-width:70%; height:auto;" }

## 1.1 Nhiều người học ngoại ngữ "thất bại" do đâu?

Có một số lượng không nhỏ những người bắt đầu học Tiếng Đức để có thể trải nghiệm nội dung bằng Tiếng Đức hoặc để có thể nói Tiếng Đức trôi chảy và một số các mục tiêu khác. Dù vậy, không ít người sau nhiều năm học vẫn không thể đạt được mục tiêu ấy. Do việc học ngoại ngữ quá khó? Hay do chưa đủ chăm?
...
Ví dụ: Xem phim Đức không sử dụng phụ đề là một cách ta thực hiện immersion Tiếng Đức.
...
Immersion là khi bạn tương tác với nội dung tự nhiên bằng ngôn ngữ mục tiêu (ở đây là Tiếng Đức). Là nội dung KHÔNG hề được làm hoặc chọn lọc kỹ càng cho người học mà được làm bởi chính người bản ngữ cho người bản ngữ. Bạn không cần phải sang nước đó hay nói chuyện trực tiếp với người bản ngữ để có thể immersion. Chỉ cần bạn tiếp cận được các nội dung bằng ngôn ngữ mục tiêu là được, ví dụ như xem Youtube Tiếng Đức chẳng hạn.
...
Mục tiêu của phần này là giúp người học nhận diện mặt chữ và phát âm tương đối đúng các âm cơ bản trong tiếng Đức, đặc biệt là những âm khác với tiếng Việt như “ch”, “sch”, “ö”, “ü”. Trước hết, người học nên xem toàn bộ bảng chữ cái để biết tiếng Đức có những chữ và tổ hợp âm nào, sau đó xem video hướng dẫn phát âm và đọc theo thành tiếng. Không cần ghi nhớ hoàn hảo hay phân biệt mọi sắc thái phát âm, chỉ cần nghe – đọc theo và nhận ra được các âm khi gặp lại.

<iframe width="560" height="315" src="https://www.youtube.com/embed/xYuPIQMvEsg?si=EOwI9T_QiOEwpHJ3" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
...
Việc học ngữ pháp tương đối quan trọng trong việc học Tiếng Đức. Có rất nhiều tài liệu ngữ pháp ngoài kia, tốt cũng có mà không tốt cũng có. Chỉ có một nguồn học ngữ pháp là không đủ cho tất cả mọi người.
...
- [Ngữ Pháp Tiếng Đức A1.1](https://www.youtube.com/playlist?list=PL5aBMauj57NuKkV9sVMUUiXGVsx_dnNZ_)
- [Ngữ pháp Tiếng Đức của DeutschFlex](https://www.youtube.com/playlist?list=PLEoRTUA8DxB5KN0MPZUWWNWnEaV-LvVkP)
...
Để giúp cho việc đọc Tiếng Đức trở lên dễ dàng hơn thì có thể Yomitan trên trình duyệt. Đọc [hướng dẫn tải xuống](yomitan.md) 
...
Nghe "thụ động" là khi bạn làm việc khác và nghe ở chế độ nền. Nếu bạn có lối sống bận rộn thì có thể tranh thủ từng khoảnh khắc để nghe. Bạn nên thực hành thực hiện immersion "thụ động" để lấp đầy những khoảng trống - những lúc mà bạn thường không học Tiếng Đức.
...
Ở giai đoạn đầu, bạn nên theo tỷ lệ nghe và đọc là 7:3. Do nghe là hình thức tự nhiên nhất của ngôn ngữ, vì vậy mình tin rằng việc ưu tiên nó là điều cần thiết để khiến bộ não của bạn xử lý Tiếng Đức một cách tự nhiên hơn.

Bạn có thể bắt đầu giảm thời lượng nghe xuống theo tỷ lệ đều 5:5 khi Tiếng Đức của bạn đã tốt hơn.
...
!!! failure "Cách học sai"
    Học Tiếng Đức cơ bản, sau đó học TẤT CẢ 1000 từ trong bộ thẻ từ vựng, sau đó học TẤT CẢ ngữ pháp trước khi bạn thử immerse lần đầu tiên..
 
Đây là một cách tiếp cận rất tệ. Cần thực hiện mỗi thứ một chút.

### Cách làm đúng 

Khi bạn vẫn đang học từ vựng cơ bản, bạn nên thử bằng xem thứ gì đó bằng Tiếng Đức mà không có phụ đề để xây dựng tinh thần immersion. Nó có thể là bất cứ điều gì bạn thích và bạn không cần phải hiểu bất cứ điều gì.
...
Trái lại với những gì mà nhiều phương pháp học tập dựa trên immersion nói, mình không tin rằng việc không thực hiện "output" của bạn cho đến khi bạn thực sự giỏi là một điều tốt vì những lý do kiểu như "nói sai sẽ ảnh hưởng xấu đến Tiếng Đức của mình". Điều này khiến bạn bỏ lỡ rất nhiều cơ hội để tiếp thu những thứ sẽ sử dụng trong việc output của mình sớm hơn và khiến bạn mang trong mình chủ nghĩa hoàn hảo độc hại và trở nên quá bảo vệ Tiếng Đức của bản thân.

## 3.2 Phát âm

Nghe nhiều hơn để có một phát âm tự nhiên và giống người nói Tiếng Đức bản ngữ nhất. Những người học muốn tiến xa hơn có thể thử học IPA, lý tưởng nhất là càng sớm càng tốt.

## Kết thúc hướng dẫn: giai đoạn sau và hơn thế nữa

Quá trình học Tiếng Đức chỉ đơn giản là thực hiện Immersion thật nhiều và học từ vựng với ngữ pháp. Bạn thực sự có thể thông thạo Tiếng Đức bằng phương pháp này.

Bạn cũng sẽ bắt đầu tự làm thẻ từ vựng của mình từ những từ mình tiếp xúc trong quá trình học Tiếng Đức, được gọi là *mining*. Bạn có thể đọc [Hướng dẫn mining trên trang này](mining.md) (Đây là hướng dẫn sử dụng công cụ để giúp quá trình mining được nhanh hơn. Bạn nên đọc bài [Sentence Mining (Đào câu)](/ngoai-ngu/sentence-mining/) để tìm hiểu thêm). Mining về cơ bản sẽ trở thành phần trọng tâm của *việc học* Tiếng Đức.
...
Bài viết này được dịch từ bài [Japanese Guide](https://learnjapanese.moe/guide/) và đã hiệu đính lại để phù hợp với những người học Tiếng Đức.